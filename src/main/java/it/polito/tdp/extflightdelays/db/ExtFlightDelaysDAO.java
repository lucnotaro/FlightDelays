...
public class ExtFlightDelaysDAO {
	...
	public List<Airport> getVertici(Integer nAirlains,Map<Integer,Airport> idMap){
        String sql = "SELECT a.ID, a.IATA_CODE "
	...
	public List<Rotta> getRotte(Map<Integer,Airport> idMap){
		...
		try {
			...
			ResultSet rs = st.executeQuery();
			while (rs.next()) {
				Rotta rotta=new Rotta(idMap.get(rs.getInt("ORIGIN_AIRPORT_ID")),idMap.get(rs.getInt("DESTINATION_AIRPORT_ID")),rs.getInt("n"));
				result.add(rotta);
			}
			conn.close();
			return result;
